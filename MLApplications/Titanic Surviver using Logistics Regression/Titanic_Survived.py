...
def Titanic_Logistic(): 
    ...
    # missing values gets filled via get_dummies
    ...
    x = Titanic_Data.drop("Survived", axis = 1) #independent variables drop survived and take the rest 
    y = Titanic_Data["Survived"] #dependent variable / label 
    ...
    obj.fit(x_train, y_train) # a,b

    # ***********************************
    # Step 5 : Test / Train The Data Set
    # ***********************************
    # e
    output = obj.predict(x_test) # c
